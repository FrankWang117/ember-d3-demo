...
export default class D3 extends Route.extend({
  ...
  model() {
    return hash({
      ...
      mapData: [
        ["广东", 1, 73016024],
        ["河南", 1, 60152736], ["四川", 1, 27159970], ["山东", 1, 43637940], ["湖北", 1, 35873840], ["云南", 1, 17326168], ["安徽", 1, 21021256], ["江苏", 1, 60300712], ["广西", 1, 22048222], ["新疆", 1, 16058669], ["山西", 1, 13599313], ["黑龙江", 1, 15741184], ["内蒙古", 1, 10746780], ["甘肃", 1, 11707872], ["湖南", 1, 25126570], ["海南", 1, 4299725], ["河北", 1, 32167712], ["辽宁", 1, 26218364], ["江西", 1, 16163486], ["浙江", 1, 54601164], ["贵州", 1, 15356775], ["陕西", 1, 23325402], ["西藏", 1, 647135.5], ["福建", 1, 24284596], ["吉林", 1, 13055209], ["青海", 1, 1306673.5], ["宁夏", 1, 7425240], ["天津", 1, 16975870], ["北京", 1, 40752892], ["上海", 1, 22434950], ["重庆", 1, 11345040]]
    })
  }
}) {
